 ...
 * LearnedAiController has its own memory that is created when the AI player is spawned. The card memory is accessible
 * via LearnedAiController.getCardMemory.
 *
 * @author Forge
 */
public class LearnedAiCardMemory {
