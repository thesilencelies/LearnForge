...
public class PlayerPanel extends FPanel {
    ...
    private FRadioButton radioLearned;
    ...
    private void createPlayerTypeOptions() {
        ...
        radioLearned = new FRadioButton("Learned AI");
        ...
        radioLearned.setComponentPopupMenu(menu);
        ...
        radioLearned.addMouseListener   (radioMouseAdapter(radioLearned,    LobbySlotType.LEARNEDAI));
